                    ...
                    <div className="back">
                        <div className="row one column">
                            <div className="column">
                                <div className="row one column">
                                    <div className="column">
                                        <span className="day-week">Something hidden here</span>
                                        <span className="date">We hide</span>
                                    </div>
                                </div>
                            </div>
                            <div className="row one column">
                                <div className="column">
                                    <span className="day-icon"><Skycon className="icon-day" color='green' icon={icon === 'partly-cloudy-night' ? 'clear-day' : icon} /></span>
                                    <span className="temperatureMax-day">{temperatureMax}&nbsp;°</span>
                                    <span className="temperatureMin-day">{temperatureMin}&nbsp;°</span>
                                </div>
                            </div>
